  ...
  module.exports = plop => {
    plop.setGenerator('component', {
      ...
      actions: [
        {
          type: 'add',
          path: 'src/components/core/{{pascalCase name}}/{{pascalCase name}}.js',
          templateFile:
            'plop-templates/Component/Component.js.hbs',
        },
        {
            type: 'add',
            path: 'src/components/core/{{pascalCase name}}/{{pascalCase name}}.stories.js',
            templateFile:
              'plop-templates/Component/Component.stories.js.hbs',
          },
        {
          type: 'add',
          path: 'src/components/core/{{pascalCase name}}/index.js',
